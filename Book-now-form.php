        ...
        if ((!@$full_nameErr) && (!@$company_nameErr) && (!@$company_roleErr) && (!@$departmentErr) && (!@$number_of_companyErr) && (!@$employee_wellbeingErr) && (!@$time_contactErr) && (!@$company_websiteErr) && (!@$working_emailErr) && (!@$phone_numberErr) && (!@$identified_companyErr) && (!@$expectationErr) && (!@$reCAPTCHAErr)) {
            ...
            if (!$res) {
                ...
                <script>
                    ...
                    setTimeout(function () {
                        window.location.href = 'Book-now-form.php';
            ...
            <div class="row">
                <div class="col">
                    <div class="form-group">
                        <h4>Dear Visitor,</h4>
                        <p>Thank you for expressing interest in our obligation-free Total Empowerment Audit. To assist
                            you better, we kindly ask you to provide the following information:
                        </p>
                    </div>
                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="phone_number" class="form-control" minlength="10"
                                            maxlength="10" value="<?php echo $phone_number ?? '' ?>">
                                        <span class="text-danger">
                                            <?php
                                            if (@$phone_numberErr) {
