...
if($_GET['delete']) { 
 ...
 $res = $db_handle->runQuery("DELETE FROM about WHERE id=$id");
    ...
    <div class="card">
              <div class="card-header">
                <h3 class="card-title">Add about Image</h3>
                   <a href="aboutadd.php"><button type="button" class="btn btn-primary" style="float: right; width: 10%;">
                                Add
                              </button></a>
              </div>
              <!-- /.card-header -->
...
foreach($result as $row) { ?>
          ...
          <td ><img src="<?php echo $row['image'];?>"style="width:100px;height:100px;"></td>
                    ...
                    <td>
                      <a href="aboutedit.php?id=<?php echo $row['id']; ?>"> <button class="btn  btn-xl btn-success">Edit</button></a>
