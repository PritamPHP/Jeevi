        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form action="emergencysave.php" enctype="multipart/form-data" method="post">
                <div class="card-body">
                    <div class="row">
                    <div class="col-md-6">
                    ...
                    <textarea class="form-control" name="description1" id="exampleFormControlTextarea1" rows="5"></textarea>
                    </div>
                    </div>
                    </div>
                    <!--<div class="form-group">
