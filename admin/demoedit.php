        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- form start -->
              <?php
$result = $db_handle->runQuery("select * from demo where id='".$_REQUEST['id']."'");
foreach($result as $row) { ?> 
              <form action="demoupdate.php" enctype="multipart/form-data" method="post">
                <div class="card-body">
                <div class="row">
                    <div class="col-md-6">
                  ...
                  <div class="form-group"> 
                    <label for="exampleInputFile">demo Image</label>
                  ...
                  <div class="form-group">
                    <label for="exampleFormControlFile1" >demo Image</label>
