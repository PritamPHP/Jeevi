...
if ($_GET['delete']) {
    ...
    $sql = "DELETE FROM `obligation_free_assessment_form` WHERE `id` = {$_GET['delete']} ;";

    if (mysqli_query($db_handle->connectDB(), $sql)) {
        echo '<script>alert("Deleted successfully"); 
          window.location.href="Obligation-free-assessment-form-show.php";</script>';
    } else {
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Obligation Free Assessment </a></li>
                            ...
                            <table id="example1" class="table table-bordered table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Phone Number</th>
                                        <th>Preferred Time for Contact </th>
                                ...
                                <tbody>
                                    <?php
                                    $i = 1;
                                    $result = $db_handle->runQuery("select * from obligation_free_assessment_form ");
