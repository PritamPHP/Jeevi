...
<section class="c-benefit-w">
    <div class="container">
        <div class="c-benefit-hw">
            ...
            <p>The program includes Employee Wellbeing Program With 2 days workshop <br> Including Life coaching, Diet coaching and Yoga coaching 
</p>
        </div>
                            ...
                            <div class="col-md-6">
                                <div class="c-benefit-tab-con-in">
                                    <div class="c-benefit-tab-con-box">
                                        <h3>Two day workshop outlines for a Employees' Wellbeing Program </h3>
                                        <p>
When: At the time agreed by us.<br>
Where: At your workplace/online or onsite<br>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="c-benefit-tab-con-in">
                                    <div class="c-benefit-tab-con-box">
                                        <h3>Day 1:</h3>
                                        <p>Introduction to Employee Wellbeing Program
Importance of employee wellbeing
Benefits of life coaching, diet coaching, and yoga coaching.<br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Life coaching session:</span>
Identify personal goals and areas of improvement.
...
Developing a personalized nutrition plan.<br>
...
Positive thinking and mindfulness techniques. <br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Diet coaching session:</span>
Review of personalized nutrition plans.
Identifying areas of progress and improvement.
Healthy meal planning and preparation tips. <br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Yoga coaching session:</span>
Intermediate yoga poses and flow sequences.
...
<br>
        <div class="c-benefit-hw">
            ...
            <p>This outline provides a general framework for a two-day Employee Wellbeing Program that includes life coaching, diet coaching, and yoga coaching. The company can collaborate with our Team of Life coaches, Dietitians and Yoga Practitioners and we can adjust the content and structure of the program as needed to meet the specific needs and goals of your organization and participants. Additionally, JEEVI programs also incorporate interactive activities and group discussions to engage and involve the participants in the workshops. By the end of the workshop, employees will have a personalized wellbeing plan that they can continue to use and build upon in their daily lives.
