...
<section class="c-benefit-w">
    <div class="container">
        <div class="c-benefit-hw">
            ...
            <p>Patients’ Wellbeing Program  With 2 days workshop <br>Including Life coaching, Diet coaching and Yoga coaching</p>
        </div>
                            ...
                            <div class="col-md-6">
                                <div class="c-benefit-tab-con-in">
                                    <div class="c-benefit-tab-con-box">
                                        <h3>Two day workshop outlines for a Patients' Wellbeing Program:</h3>
                                        <p>
When: At the time agreed by us.<br>
Where: At your group home, home, hospital, nursing homes/online or onsite.<br>
...
<span style="text-decoration-line: underline;
 ...
 Life Coaching for Patients' Wellbeing.<br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Session 3: </span>
Nutrition and Diet Coaching for Patients.<br>Lunch break<br>


<span style="text-decoration-line: underline;
    font-weight: bold;">Session 4:</span>
Yoga and Meditation for Patients' Wellbeing.<br>


<span style="text-decoration-line: underline;
    font-weight: bold;">Session 5:</span>
Mindful Eating Practices.<br>
...
Life Coaching for Overcoming Health Challenges.
 <br>
 Lunch break<br>
...
<br>
        <div class="c-benefit-hw">
            ...
            <p>The program will be designed with patient needs in mind, taking into consideration their specific medical conditions and limitations. Sessions will be facilitated by qualified professionals with experience in patient care, and will aim to provide a holistic approach to wellbeing that addresses physical, emotional, and spiritual needs. Additionally, JEEVI programs also incorporate interactive activities and group discussions to engage and involve every participants in the workshops. By the end of the workshop, every patient will have a personalized wellbeing plan that they can continue to use and build upon in their daily lives.
