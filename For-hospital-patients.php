...
<head>
  <title>Life Coaches in Australia | Employee Wellness Program Sydney</title>
  	<meta name="description" content="Looking for counselling & wellness services in Sydney? Our corporate wellness programs and life coaches at JEEVI can help boost employee well-being and productivity.">
...
<section class="c-benefit-w">
    <div class="container">
        ...
        <div class="tab-content" id="pills-tabContent">
              <div class="tab-pane fade show active" id="benifit-tab-4" role="tabpanel" >
              <?php
