                        ...
                        <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                 ...
                                 <!--<h3 class="mb-2 mt-3"> Family details</h3>-->
                                    <!-- Number of Family Members  -->
...
<div class="row">
    <div class="col-md-12">
        <div class="form-group">
            <h3>Challenges Faced by the Family (Tick as many boxes as applicable): <strong>*</strong> </h3>
            <div class="c-form-checkbox-w">

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="communicationIssues"
                        value="Communication Issues">
                    <label class="form-check-label">Communication Issues</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="financialStrain"
                        value="Financial Strain">
                    <label class="form-check-label">Financial Strain</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="relationshipStruggles"
                        value="Relationship Struggles">
                    <label class="form-check-label">Relationship Struggles</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="parentingChallenges"
                        value="Parenting Challenges">
                    <label class="form-check-label">Parenting Challenges</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="stressAndAnxiety"
                        value="Stress and Anxiety">
                    <label class="form-check-label">Stress and Anxiety</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="workLifeBalance"
                        value="Work-Life Balance">
                    <label class="form-check-label">Work-Life Balance</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="mentalHealthConcerns"
                        value="Mental Health Concerns">
                    <label class="form-check-label">Mental Health Concerns</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="griefOrLoss"
                        value="Grief or Loss">
                    <label class="form-check-label">Grief or Loss</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="culturalOrIdentityIssues"
                        value="Cultural or Identity Issues">
                    <label class="form-check-label">Cultural or Identity Issues</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="lackOfUnderstanding"
                        value="Lack of Understanding">
                    <label class="form-check-label">Lack of Understanding</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="angerManagement"
                        value="Anger Management">
                    <label class="form-check-label">Anger Management</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" name="challenges[]" type="checkbox" id="otherChallenges"
                        value="Other">
            ...
            <span class="text-danger">
                ...
                ?>
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                     <div class="form-group">
                                        <h3> Is your partner aware that you are filling out this form? (Yes/No)<strong>*</strong> </h3>
                                         <div class="c-form-checkbox-w">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                     <div class="form-group">
                                        <h3>Is your partner willing to attend this session with you?<strong>*</strong> </h3>
                                         <div class="c-form-checkbox-w">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                     <div class="form-group">
                                        <h3>Do you prefer to participate in this session alone or with your partner?<strong>*</strong> </h3>
                                         <div class="c-form-checkbox-w">
                            ...
                            <div class="col-md-10">
                                  <p>Thank you for filling out the form. One of our staff members will contact you soon to schedule an obligation-free and confidential session. Rest assured that our services are confidential, and there's no judgment for any situation you may be facing. We're here to support you.</p>
