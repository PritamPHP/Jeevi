...
<section class="c-benefit-w">
    <div class="container">
        <div class="c-benefit-hw">
            ...
            <p>Students Wellbeing Program  With 2 days workshop <br> Including Life coaching, Diet coaching and Yoga coaching
</p>
        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="c-benefit-tab-con-in">
                                    <div class="c-benefit-tab-con-box">
                                        <h3>Day 1:</h3>
                                        <p>Introduction to Student Wellbeing Program.<br>
Understanding the importance of self-care and mental health.<br>
Benefits of life coaching, diet coaching, and yoga coaching for students.<br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Life coaching session:</span>
Identifying personal goals and areas of improvement.
Developing strategies for managing stress and anxiety.
Time management techniques.<br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Diet coaching session:</span>
Understanding nutrition and the importance of a balanced diet.
Identifying dietary needs and preferences.
Developing healthy meal planning and preparation tips for students on a budget.<br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Yoga coaching session:</span>
Introduction to yoga and its benefits for students.
Basic yoga poses and breathing exercises for stress relief and relaxation.
</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="c-benefit-tab-con-in">
                                    <div class="c-benefit-tab-con-box">
                                    <h3>Day 2:</h3>
                                        <p>Review of Day 1 <br>

<Span style="text-decoration-line: underline;
    font-weight: bold;">Life coaching session:</Span>
Goal-setting and progress tracking.
Developing positive self-talk and self-confidence.
Mindfulness and meditation techniques. <br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Diet coaching session:</span>
Review of healthy meal planning and preparation tips.
Identifying areas of progress and improvement.
Strategies for eating healthy on campus and managing late-night cravings. <br>

<span style="text-decoration-line: underline;
    font-weight: bold;">Yoga coaching session:</span>
Intermediate yoga poses and flow sequences for stress relief and energy.
Yoga for improving posture and concentration.
Yoga for mental and emotional wellbeing. <br>
</p>       
                                </div>
                                </div>
                            </div>
...
<br>
        <div class="c-benefit-hw">
            ...
            <p>This outline is designed to meet the specific needs of students and provide them with tools and strategies for improving their overall wellbeing. JEEVI can tailor the content and structure of the workshop to best suit the needs and goals of your students. Additionally, JEEVI programs also incorporate interactive activities and group discussions to engage and involve the student participants in the workshops. By the end of the workshop, students will have a personalized wellbeing plan that they can continue to use and build upon in their daily lives.
